...
# This launch is responsible for launching the OctoMap creation process with the YOLO World
...
def launch_setup(context, *args, **kwargs):
            ...
            moveit_launch_file = IncludeLaunchDescription(
                ...
                launch_arguments={
                    "rviz_file": os.path.join(
                        get_package_share_directory("av_bringup"), "rviz/", config_yaml["launch"]["octomap_segmentation_yolo_world_launch"]["rviz"]["real"] ),
                }.items(),
            )
    ...
    yolo_world_segmentation_launch_file = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("av_segmentation_yolo_world"), '/launch', '/yolo_world.launch.py']),
        launch_arguments={
            **use_sim_time_dict,
            **{
