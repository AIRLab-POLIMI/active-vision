...
using SyncPolicyArray = message_filters::sync_policies::ApproximateTime<av_interfaces::msg::PointcloudArray, geometry_msgs::msg::TransformStamped, sensor_msgs::msg::PointCloud2>;
...
namespace extended_octomap_server{
    ...
    protected:
        ...
        std::shared_ptr<message_filters::Subscriber<
                            av_interfaces::msg::PointcloudArray>> segmentedPointcloudsArraySub;
