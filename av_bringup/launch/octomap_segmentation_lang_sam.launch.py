...
# This launch is responsible for launching the OctoMap creation process with the LANG SAM
...
def launch_setup(context, *args, **kwargs):
            ...
            moveit_launch_file = IncludeLaunchDescription(
                ...
                launch_arguments={
                    "rviz_file": os.path.join(
                        get_package_share_directory("av_bringup"), "rviz/", config_yaml["launch"]["octomap_segmentation_lang_sam_launch"]["rviz"]["real"] ),
                }.items(),
            )
    ...
    lang_sam_segmentation_launch_file = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("av_segmentation_lang_sam"), '/launch', '/lang_sam.launch.py']),
        launch_arguments={
            **use_sim_time_dict,
            **{
