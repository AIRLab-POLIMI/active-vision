...
#include <igus_rebel_gazebo_ignition/joint_state_publisher.hpp>
...
int main(int argc, char* argv[])
{
    ...
    ros_node->declare_parameter("ign_topic", ign_topic);
    ...
    // create publisher
    auto joint_publisher = std::make_shared<igus_rebel_gazebo_ignition::JointStatePublisher>(ros_node,
