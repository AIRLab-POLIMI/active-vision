...
#include <av_interfaces/srv/yolo_world_segmentation.hpp>
...
using PointcloudArray = av_interfaces::msg::PointcloudArray;
...
namespace active_vision_pipeline{
    ...
    protected:
        ...
        rclcpp::Client<av_interfaces::srv::YOLOWorldSegmentation>::SharedPtr client_;
