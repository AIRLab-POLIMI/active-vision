...
#include <igus_rebel_gazebo_ignition/joint_position_controller.hpp>
#include <igus_rebel_gazebo_ignition/joint_trajectory_controller.hpp>
...
int main(int argc, char* argv[])
{
    ...
    // create controller
    auto joint_trajectory_controller = std::make_shared<igus_rebel_gazebo_ignition::jointTrajectoryController>(ros_node,
        joint_names, "set_joint_trajectory", ign_joint_topics ,update_rate);
    // create controller 
    auto joint_position_controller = std::make_shared<igus_rebel_gazebo_ignition::JointPositionController>(ros_node,
