...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('utility_type', default_value='expected_semantic_information_gain'),
        DeclareLaunchArgument('utility_vis', default_value='False'),
    ...
    Node(
        ...
        executable='main_nbv_planning_pipeline',
        output='screen',
        arguments= [
            "--ros-args",
            "--log-level",
            "main_nbv_planning_pipeline:=info",
        ],
        ...
        parameters=moveit_loader.load_moveit(with_sensors3d=False) + [
            ...
            "utility_type": LaunchConfiguration("utility_type"),
            "utility_vis": LaunchConfiguration("utility_vis"),
