...
def launch_setup(context, *args, **kwargs):
        ...
        moveit_launch_file = IncludeLaunchDescription(
            ...
            launch_arguments={
                "rviz_file": os.path.join(
                    get_package_share_directory("fruit_picking_bringup"), "rviz/active_vision_nbv_planning_pipeline.rviz"),
            }.items(),
        )
    ...
    if LaunchConfiguration("run_active_vision_pipeline").perform(context) == 'true': 
        predefined_planning_pipeline_launch_file = IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare("fruit_picking_planning"), '/launch', '/nbv_planning_pipeline.launch.py']),
            launch_arguments={
                **use_sim_time_dict,
                **{
