...
def generate_launch_description():
    ...
    Node(
        ...
        parameters=moveit_loader.load_moveit(with_sensors3d=False) + [
            ...
            "central_attention_front_distance_ratio": LaunchConfiguration("central_attention_front_distance_ratio"),
            "central_attention_height_distance_ratio": LaunchConfiguration("central_attention_height_distance_ratio"),
            "central_attention_width_distance_ratio": LaunchConfiguration("central_attention_width_distance_ratio"),
